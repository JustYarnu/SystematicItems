...
class Item:
    ...
    damage_type: str = "Physical" # Literally just the 5e damage types
    crit_damage: float = 1.5      # Multiplier for critical hits
    crit_rate: float = 0.05       # 0.0 to 1.0 chance
    str_mod: float = 0.0          # Strength bonus (scales damage)
    dex_mod: float = 0.0          # Dexterity bonus (scales crit rate)
    ...
    resilience: float = 0.5       # Resistance to negative mutations
    worth: int = 0 # How much currency is gained on breaking (more mutations = more currency)
